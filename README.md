...
| ✉️ | `send_message path/to/tdata target "text"` | Sends a message; joins the target group first if you are not yet a member |
...
| 🏗️ | `group_create path/to/tdata "Title" @username` | Creates a new public supergroup |
