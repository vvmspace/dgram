...
call expects - passing None through for whichever of --path-to-tdata and
--session was left unspecified, so libs.dgram.get_client can tell an
explicit choice apart from its own default.
"""
